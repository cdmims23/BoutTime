...
class GameModel {
    ...
    func removeEvents() {
        // Remove the contents of the array so that the game can be played again
        numbers.removeAll()
    }
